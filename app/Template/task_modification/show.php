<?= $this->render('task/form_modern_styles') ?>

<div class="kb-task-form-modal">
    <div class="page-header">
        <h2><?= $this->text->e($project['name']) ?> &gt; <?= $this->text->e($task['title']) ?></h2>
    </div>
    <form method="post" action="<?= $this->url->href('TaskModificationController', 'update', array('task_id' => $task['id'])) ?>" autocomplete="off" class="kb-task-form-shell">
        <?= $this->form->csrf() ?>

        <div class="task-form-container kb-task-form-grid">
            <div class="task-form-main-column kb-task-form-column kb-task-form-column-main">
            ...
            <div class="task-form-secondary-column kb-task-form-column">
            ...
            <div class="task-form-bottom kb-task-form-actions">
