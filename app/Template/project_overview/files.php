<?php if (! empty($files)): ?>
    <div class="kb-project-overview-files-table-wrap">
        <table class="table-striped table-scrolling kb-project-overview-files-table">
            <thead>
                <tr>
                    <th><?= t('Filename') ?></th>
                    <th><?= t('Creator') ?></th>
            ...
            <tbody>
                <?php foreach ($files as $file): ?>
                    <tr>
                        <td class="kb-project-overview-file-name">
                            <span class="kb-project-overview-file-icon">
