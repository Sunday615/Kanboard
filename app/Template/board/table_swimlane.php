<!-- swimlane -->
<tr id="swimlane-<?= $swimlane['id'] ?>" class="kb-board-swimlane-row">
   <th class="board-swimlane-header kb-board-swimlane-header" colspan="<?= $swimlane['nb_columns'] ?>">
        <?php if (! $not_editable): ?>
            <a href="#" class="board-swimlane-toggle kb-board-swimlane-toggle" data-swimlane-id="<?= $swimlane['id'] ?>">
        ...
        <span class="kb-board-swimlane-name"><?= $this->text->e($swimlane['name']) ?></span>
        ...
        <span title="<?= t('Number of tasks in this swimlane') ?>" class="board-column-header-task-count swimlane-task-count-<?= $swimlane['id'] ?> kb-board-swimlane-count">
