...
<tr class="board-swimlane-columns-<?= $swimlane['id'] ?>">
    ...
    <th class="board-column-header board-column-header-<?= $column['id'] ?> kb-board-column-header" data-column-id="<?= $column['id'] ?>">

        <!-- column in collapsed mode -->
        <div class="board-column-collapsed kb-board-column-collapsed">
        ...
        <div class="board-column-expanded board-column-expanded-header kb-board-column-shell">
            <div class="kb-board-column-main">
                ...
                <span class="board-column-title kb-board-column-title">
                    <?php if ($not_editable): ?>
                        <?= $this->text->e($column['title']) ?>
                    <?php else: ?>
                        <span class="dropdown kb-board-column-menu">
                            ...
                            <?php if ($column['nb_tasks'] > 0 && $this->user->hasProjectAccess('TaskModificationController', 'update', $column['project_id'])): ?>
                                <span class="dropdown kb-board-column-sort">
